...
import com.invman.InvrntoryManagementSystem.entity.Transaction;
...
//we are searching these field; Transaction's description, note, status, Product's name, sku no usages
    @Query("SELECT t FROM Transaction t " +
